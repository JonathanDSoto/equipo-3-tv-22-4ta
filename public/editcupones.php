                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="name" type="text" class="form-control" id="couponname" placeholder="Enter coupon name" value="15% off">
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="description" type="text" class="form-control" id="description" placeholder="Enter Percentage discount" value="15">
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="description" type="text" class="form-control" id="description" placeholder="Enter Min amount required" value="500">
                                                            </div>
                    				                        <p class="formulario__input-error text-danger" id="grupo_lastname">The format only accepts letters and spaces.</p>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="description" type="text" class="form-control" id="description" placeholder="Enter Min product required" value="5">
                                                            </div>
                    				                        <p class="formulario__input-error text-danger" id="grupo_lastname">The format only accepts letters and spaces.</p>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="description" type="text" class="form-control" id="description" placeholder="Enter Max uses" value="100">
                                                            </div>
                    				                        <p class="formulario__input-error text-danger" id="grupo_lastname">The format only accepts letters and spaces.</p>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="description" type="text" class="form-control" id="description" placeholder="Enter Start date, example: 2022-08-15" value="2022-10-29">
                                                            </div>
                    				                        <p class="formulario__input-error text-danger" id="grupo_lastname">The format only accepts letters and spaces.</p>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="description" type="text" class="form-control" id="description" placeholder="Enter End date, example: 2022-09-28" value="2022-10-30">
                                                            </div>
                    				                        <p class="formulario__input-error text-danger" id="grupo_lastname">The format only accepts letters and spaces.</p>
