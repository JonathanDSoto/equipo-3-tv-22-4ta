                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="name" type="text" class="form-control" id="couponname" placeholder="Enter Folio" value="12312">
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="description" type="text" class="form-control" id="description" placeholder="Enter price" value="4000">
                                                            </div>
