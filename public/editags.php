                                            ...
                                            <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab">
                                                        <i class="fas fa-home"></i> Tags Details
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="name" type="text" class="form-control" id="tagname" placeholder="Enter tag name" value="Jardin">
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="description" type="text" class="form-control" id="description" placeholder="Enter tag description" value="Articulos para el cuidado del jardin">
                                                            </div>
