        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <form method="post" action="<?= BASE_PATH ?>category" id="form">
                        <div class="row">
                            <div class="col">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="name" type="text" class="form-control" id="name" placeholder="Enter the category name" value="<?= $source->name ?>">
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="description" type="text" class="form-control" id="description" placeholder="Enter the category description" value="<?= $source->description ?>">
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                ...
                                                                <a href="categorias" type="button" class="btn btn-soft-success">Cancel</a>
