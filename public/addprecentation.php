                                                ...
                                                <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab">
                                                            <i class="fas fa-home"></i> Category Details
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                                    ...
                                                    <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 text-start">
                                                                ...
                                                                <p class="formulario__input-error text-danger" id="grupo_status">The format only accepts letters and spaces.</p>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                ...
                                                                <p class="formulario__input-error text-danger" id="grupo_stock">The format only accepts letters and spaces.</p>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                ...
                                                                <p class="formulario__input-error text-danger" id="grupo_stock_min">The format only accepts letters and spaces.</p>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                ...
                                                                <p class="formulario__input-error text-danger" id="grupo_stock_max">The format only accepts letters and spaces.</p>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label for="features" class="form-label">features</label>
                                                                    <input name="features" type="text" class="form-control" id="features" placeholder="Enter the features" value="">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input name="cover" type="file" class="form-control" id="cover" placeholder="Enter the features" value="">
                                                                </div>
                                                                <p class="formulario__input-error text-danger" id="grupo_features">The format only accepts letters and spaces.</p>
